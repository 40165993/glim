...
<%--	</div>--%>
<%--</div>--%>
<div class="site-blocks-cover inner-page-cover overlay" style="background-image: url(/resources/real.jpg); background-position: 50% -71px;" data-stellar-background-ratio="0.5">
	<div class="container">
		<div class="row align-items-center justify-content-center text-center">
			<div class="col-md-12 aos-init aos-animate" data-aos="fade-up" data-aos-delay="400">
				<div class="row justify-content-center mb-4">
					<div class="col-md-8 text-center">
						<h1>잊고 있던 작가의 꿈을 펼쳐보세요</h1>
						<p class="lead mb-5">You can make anything by writing</p>
					</div>
				</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12 ml-auto">
				<br>
<%--				<h2 class="h4 text-black mb-5">글 작성하기</h2>--%>
				<form action="writeProc.board" method="post"
					...
					<div class="row form-group">
						<div class="col-md-12">
							...
							<input type="text" class="form-control" id="title" name="title" size="50" placeholder="제목을 입력해주세요">
						</div>
					</div>
